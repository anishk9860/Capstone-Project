...
@Component({
  selector: 'app-search-result1',
  templateUrl: './search-result1.component.html',
  styleUrls: ['./search-result1.component.scss']
})
export class SearchResult1Component implements OnInit {
