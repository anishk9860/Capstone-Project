...
@Component({
  selector: 'app-filter-by-cuisine',
  templateUrl: './filter-by-cuisine.component.html',
  styleUrls: ['./filter-by-cuisine.component.scss']
})
export class FilterByCuisineComponent implements OnInit {
  ...
  applyFilter(event:any) {
    if(event.target.value === 'All') {
      ...
      this.router.navigate(['filter-by-cuisine1']);
    }
  }
