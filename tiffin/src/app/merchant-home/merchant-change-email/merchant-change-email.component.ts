...
@Component({
  selector: 'app-merchant-change-email',
  templateUrl: './merchant-change-email.component.html',
  styleUrls: ['./merchant-change-email.component.scss']
})
export class MerchantChangeEmailComponent implements OnInit {
